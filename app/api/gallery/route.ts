...
const PRESET_DESIGNS = [
  {
    ...
    graphData: {
      ...
      "25_5": 2, "26_5": 2, "27_5": 2, "26_6": 1
    },
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 128, forks: 34, comments: 8, views: 1240, tags: ["Art"]
  },
  {
    id: "preset-invader",
    title: "Space Invader",
    ...
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 85, forks: 19, comments: 4, views: 742, tags: ["Art"]
  },
  {
    id: "preset-git",
    ...
    graphData: {
      "20_1": 4, "21_1": 4, "22_1": 4, "19_2": 4, "19_3": 4, "19_4": 4,
      "20_5": 4, "21_5": 4, "22_5": 4, "22_3": 4, "22_4": 4, "21_3": 4,
      "25_1": 4, "25_2": 4, "25_3": 4, "25_4": 4, "25_5": 4,
      "28_1": 4, "29_1": 4, "30_1": 4, "29_2": 4, "29_3": 4, "29_4": 4, "29_5": 4
    },
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 154, forks: 52, comments: 11, views: 2012, tags: ["Text"]
  },
  {
    id: "preset-logo",
    ...
    graphData: {
      "26_1": 4, "27_1": 4, "28_1": 4, "25_2": 4, "29_2": 4,
      "24_3": 4, "27_3": 4, "30_3": 4, "25_4": 4, "29_4": 4,
      "26_5": 4, "27_5": 4, "28_5": 4
    },
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 210, forks: 64, comments: 18, views: 3120, tags: ["Logos"]
  },
  {
    id: "preset-nebula",
    ...
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 1200, forks: 420, comments: 64, views: 8200, tags: ["Art", "Workflows"]
  },
  {
    id: "preset-wolf",
    ...
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 890, forks: 210, comments: 38, views: 5400, tags: ["Logos", "Art"]
  },
  {
    id: "preset-system",
    ...
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 543, forks: 98, comments: 22, views: 3100, tags: ["Text", "Art"]
  },
  {
    id: "preset-monorepo",
    ...
    previewImage: null, createdAt: new Date().toISOString(),
    creator: { id: "preset-author", name: "Studio Presets", username: "presets", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
    likes: 3400, forks: 1200, comments: 88, views: 12000, tags: ["Workflows"]
  },
];

function getFallbackPresets(tag: string, query: string) {
  let filtered = PRESET_DESIGNS;
  if (tag !== "All") {
    filtered = PRESET_DESIGNS.filter(d => d.tags.includes(tag));
  }
  if (query) {
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (sort === "newest") {
      ...
      orderByClause = { forks: { _count: "desc" } };
    } else {
      orderByClause = [
        { likes: { _count: "desc" } },
        { views: { _count: "desc" } },
